...
from .views import UserListCreateView, UserRetrieveUpdateDestroyView, NoteCreateView, NoteRetrieveUpdateDestroyView, \
    NoteAuthorCreateView, AllNotesView
...
urlpatterns = [
    ...
    path('notes/all/', AllNotesView.as_view(), name='all-notes'),
